        ...
        <div class="container-fluid">
                ...
                <div class="space">
                    ...
                    <div class="login_footer">
                        <Button type="primary" @click="login" :disabled="isLogging" :loading="isLogging">{{isLogging ? '登入中...' : '登入'}}</Button>
                    </div>
                </div>
        </div>
    </div>
...
export default {
    ...
    methods : {
        async login(){
            ...
            if (this.data.password.length < 6) return this.e("Password不得小於6個字元!");
            this.isLogging = true;
